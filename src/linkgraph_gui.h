...
protected:
	...
	bool IsLinkVisible(Point pta, Point ptb, const DrawPixelInfo *dpi, uint padding) const;
	bool IsPointVisible(Point pt, const DrawPixelInfo *dpi, uint padding) const;
