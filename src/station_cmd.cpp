...
void UpdateStationAcceptance(Station *st, bool show_msg)
{
	...
	SetWindowWidgetDirty(WC_STATION_VIEW, st->index, WID_SV_BOTTOM_PANEL);
}
...
static void UpdateStationRating(Station *st)
{
	...
	if (waiting_changed) {
		...
		SetWindowWidgetDirty(WC_STATION_VIEW, index, WID_SV_BOTTOM_PANEL); // update only ratings list
	}
}
